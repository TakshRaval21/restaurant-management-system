...
Future<void> _signInWithGoogle() async {
    ...
    return Container(
      ...
      child: Center(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Container(width: 38, height: 38,
                      decoration: BoxDecoration(color: const Color(0xFF2E8B80), borderRadius: BorderRadius.circular(10)),
                ...
                const Text('Welcome back',
                    style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: Color(0xFF141F1D), letterSpacing: -0.5)),
                const SizedBox(height: 6),
                const Text('Sign in to your restaurant dashboard',
                    style: TextStyle(fontSize: 14, color: Color(0xFF6B7B7A))),
                ...
                TextFormField(
                  ...
                  decoration: _inputDeco('manager@restaurant.com', Icons.email_outlined),
                ),
                  ...
                  decoration: _inputDeco('••••••••', Icons.lock_outline).copyWith(
                    suffixIcon: IconButton(
                      icon: Icon(_obscure ? Icons.visibility_outlined : Icons.visibility_off_outlined,
                          size: 20, color: const Color(0xFF9EAEAC)),
                ...
                Row(children: [
                  SizedBox(height: 22, width: 22, child: Checkbox(
                      value: _rememberMe, activeColor: const Color(0xFF2E8B80),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
                      side: const BorderSide(color: Color(0xFFD4E0DE), width: 1.5),
                ...
                SizedBox(width: double.infinity, height: 50,
                  child: ElevatedButton(
                    onPressed: (_loading || _googleLoading || _appleLoading) ? null : _signIn,
                    style: ElevatedButton.styleFrom(
                        backgroundColor: const Color(0xFF2E8B80), foregroundColor: Colors.white, elevation: 0,
        ...
        fit: BoxFit.contain,
                    ...
                    style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFF1C2B2A),
        ...
        fit: BoxFit.contain,
                ...
                Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                  const Text('New to RestoAdmin?', style: TextStyle(fontSize: 13, color: Color(0xFF6B7B7A))),
                  TextButton(
                ...
                Center(child: Text('© 2024 RestoAdmin Solutions Inc.\nPrivacy Policy  ·  Terms of Service',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 11.5, color: Colors.grey.shade400, height: 1.8))),
              ]),
            ),
          ),
        ),
  ...
  Widget _fieldLabel(String label) => Text(label,
      style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF1C2B2A)));
  ...
  InputDecoration _inputDeco(String hint, IconData icon) => InputDecoration(
    ...
    border:             OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFD4E0DE))),
    enabledBorder:      OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFD4E0DE))),
    focusedBorder:      OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFF2E8B80), width: 1.8)),
    errorBorder:        OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFE53935))),
    focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFE53935), width: 1.8)),
  );
}
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Stack(fit: StackFit.expand, children: [
      Image.asset('assets/images/loginbg.jpg', fit: BoxFit.cover,
          errorBuilder: (_, __, ___) => Container(color: const Color(0xFF0D1917))),
      Container(decoration: BoxDecoration(gradient: LinearGradient(
          begin: Alignment.topLeft, end: Alignment.bottomRight,
          colors: [const Color(0xFF0D1917).withOpacity(0.75), const Color(0xFF1E6B60).withOpacity(0.55)]))),
      Padding(padding: const EdgeInsets.all(52), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(width: 42, height: 42, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(11)),
              child: const Icon(Icons.restaurant, color: Color(0xFF2E8B80), size: 22)),
          const SizedBox(width: 12),
          const Text('RestoAdmin', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w800)),
        ]),
        const Spacer(),
        AnimatedTextKit(
          animatedTexts: [TypewriterAnimatedText('Master your\nkitchen,\nmanage\nyour floor.',
              textStyle: const TextStyle(fontSize: 54, height: 1.1, color: Colors.white, fontWeight: FontWeight.w900, letterSpacing: -1),
              speed: const Duration(milliseconds: 110))],
          totalRepeatCount: 1, displayFullTextOnTap: true,
        ),
        const SizedBox(height: 22),
        const Text('Experience the future of restaurant management\nwith our premium administrative suite.',
