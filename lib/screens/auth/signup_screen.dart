...
class _SignupScreenState extends State<SignupScreen>
  ...
  Future<void> _signUp() async {
    ...
    if (!_agreedToTerms) {
      _snack('Please agree to the Terms of Service.', isError: true);
      return;
    }
                ...
                child: ListView(
                  ...
                  children: const [
                    _PolicySection(
                      ...
                      content:
                          "You are responsible for maintaining the security of your account and password. RestoAdmin cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.",
                    ),
                    _PolicySection(
                      title: "2. Proper Use",
                      content:
                          "This software is for restaurant management purposes only. You may not use the service for any illegal or unauthorized purpose, including data scraping or interfering with the system's performance.",
                    ),
                    _PolicySection(
                      title: "3. Accuracy of Data",
                      content:
                          "The restaurant owner is solely responsible for the accuracy of menu prices, tax calculations (GST/VAT), and billing information generated through the app.",
                    ),
                    _PolicySection(
                      title: "4. Modifications",
                      content:
                          "RestoAdmin reserves the right to modify or discontinue the service with or without notice at any time.",
                    ),
                  ],
                ),
              ),
                ...
                child: ListView(
                  ...
                  children: const [
                    _PolicySection(
                      ...
                      content:
                          "We collect your email address, full name, and restaurant details (name, location, currency) to provide the management service.",
                    ),
                    _PolicySection(
                      title: "2. How We Use Data",
                      content:
                          "Your data is used to manage orders, generate bills, and synchronize the kitchen display. We do not sell your personal or business data to third parties.",
                    ),
                    _PolicySection(
                      title: "3. Data Storage",
                      content:
                          "We use Supabase for secure cloud storage. While we take every precaution, no method of electronic storage is 100% secure.",
                    ),
                    _PolicySection(
                      title: "4. Your Rights",
                      content:
                          "You can request to delete your account and all associated restaurant data at any time by contacting support or using the delete option in settings.",
                    ),
                  ],
                ),
              ),
            ...
            child: Form(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const Text('Start managing your restaurant today.',
                          style: TextStyle(
                              fontSize: 14, color: Color(0xFF6B7B7A))),
                      const SizedBox(height: 30),
                      _Row2([
                        _Field(_fullNameCtrl, 'Full Name', 'John Doe',
                            Icons.person_outline,
                            validator: (v) =>
                                v!.trim().isEmpty ? 'Required' : null),
                        _Field(_restaurantCtrl, 'Restaurant Name',
                            'The Golden Bistro', Icons.store_outlined,
                            validator: (v) =>
                                v!.trim().isEmpty ? 'Required' : null),
                      ]),
                      const SizedBox(height: 16),
                      _Field(_emailCtrl, 'Email Address', 'you@restaurant.com',
...
class _Field extends StatelessWidget {
  ...
  const _Field(this.ctrl, this.label, this.hint, this.icon,
      {this.keyboardType,
      this.obscure = false,
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextFormField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              hintStyle:
                  const TextStyle(fontSize: 13.5, color: Color(0xFF9EAEAC)),
          ...
          Container(
              decoration: BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [
                const Color(0xFF0D1917).withOpacity(0.80),
                const Color(0xFF1E6B60).withOpacity(0.60)
              ]))),
          Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 22),
                    const Text(
                        'Build your restaurant empire with\nour intelligent management suite.',
                        style: TextStyle(
                            fontSize: 15.5,
                    ...
                    const Row(children: [
                      _Bubble('500+', 'Restaurants'),
                      SizedBox(width: 16),
                      _Bubble('99.9%', 'Uptime'),
                      SizedBox(width: 16),
                      _Bubble('24/7', 'Support')
                    ]),
                    const SizedBox(height: 36),
                  ])),
        ]),
...
class _Bubble extends StatelessWidget {
  ...
  const _Bubble(this.value, this.label);
  @override
  Widget build(BuildContext context) => Container(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(content,
              style: const TextStyle(
                  fontSize: 14, color: Color(0xFF6B7B7A), height: 1.5)),
        ],
      ),
    );
  }
