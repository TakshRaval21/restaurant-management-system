...
class _BillingScreenState extends State<BillingScreen>
  ...
  static const _methods = ['cash', 'card', 'UPI', 'online'];
  ...
  Future<void> _load() async {
    ...
    final todayPayments = List<Map<String, dynamic>>.from(results[1]);

    // Hydrate order_items if join returned empty
    final rawReady = List<Map<String, dynamic>>.from(results[2]);
    ...
    setState(() {
      ...
      _todayRevenueVal = todayPayments.fold<double>(
          0.0, (s, p) => s + ((p['amount_paid'] as num?)?.toDouble() ?? 0));
      _loading = false;
    });
  }
              ...
              children: [
                  ...
                  child: pw.Row(
                      ...
                      children: [
                        pw.Column(
                            crossAxisAlignment: pw.CrossAxisAlignment.start,
                            children: [
                              pw.Text(pdfLabel, style: bold(7, grey600)),
                              pw.SizedBox(height: 3),
                              pw.Text(pdfValue, style: bold(20, black)),
                            ]),
                        pw.Column(
                            crossAxisAlignment: pw.CrossAxisAlignment.end,
                            children: [
                              pw.Text('DATE', style: bold(7, grey600)),
                              pw.SizedBox(height: 3),
                              pw.Text(dtStr, style: bold(9, black)),
                              pw.Text(timeStr, style: reg(9, grey600)),
                            ]),
                      ]),
                ),
                ...
                pw.Container(
                  ...
                  child: pw.Row(children: [
                    pw.Expanded(
                        flex: 10,
                        child: pw.Text('ITEM', style: bold(7.5, black))),
                    pw.SizedBox(
                        width: 24,
                        child: pw.Text('QTY',
                            textAlign: pw.TextAlign.center,
                  ...
                  return pw.Container(
                    ...
                    child: pw.Row(
                        ...
                        children: [
                          pw.Expanded(
                              flex: 10,
                              child: pw.Text(item['item_name'] as String,
                                  style: reg(9.5, black))),
                          pw.SizedBox(
                              width: 24,
                ...
                pw.Container(
                  ...
                  child: pw.Column(children: [
                    pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children: [
                          pw.Text('Subtotal', style: reg(9.5, grey600)),
                ...
                pw.Container(
                  ...
                  child: pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('GRAND TOTAL', style: bold(13, black)),
                ...
                pw.Container(
                  ...
                  child: pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Payment Mode', style: reg(9, grey600)),
                        pw.Container(
                ...
                pw.Center(
                  child: pw.Column(children: [
                    ...
                    pw.SizedBox(height: 6),
                    pw.Text('THANK YOU',
                        textAlign: pw.TextAlign.center, style: bold(11, black)),
  ...
  Future<void> _showTableBillDialog(
    ...
    String method = 'cash';
    final orderIds =
        tableOrders.map((o) => '#${o['order_number'] ?? '-'}').toList();
  ...
  Future<void> _reprintBill(Map<String, dynamic> payment) async {
    ...
    if (orderId != null) {
      try {
        final raw =
            await _sb.from('order_items').select().eq('order_id', orderId);
        items = List<Map<String, dynamic>>.from(raw);
      } catch (_) {}
    }
  ...
  Widget _buildTableCard(
      String tableNumber, List<Map<String, dynamic>> tableOrders) {
    final mergedItems = _mergeItemsFromOrders(tableOrders);
    final totals = _calculateTotals(mergedItems);
    final isParcel = tableNumber.startsWith('📦');
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color:
                  (isParcel ? const Color(0xFF7B3FF2) : const Color(0xFF004D40))
                      .withOpacity(0.2)),
          boxShadow: [
            BoxShadow(
                color: (isParcel
          ...
          Row(children: [
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(
                  ...
                  style:
                      const TextStyle(fontSize: 10, color: AppColors.textMid)),
            ]),
            const Spacer(),
            ElevatedButton.icon(
  ...
  Widget build(BuildContext context) {
    ...
    final cols =
        Responsive.gridCount(context, mobile: 1, tablet: 2, desktop: 3);
                                ...
                                children: [
                                  SizedBox(
                                      ...
                                      child: _StatCard2(
                                          ...
                                          value: _fmt.format(_todayRevenueVal),
                          ...
                          if (groupedOrders.isNotEmpty) ...[
                            ...
                            Container(
                              ...
                              child: Column(children: [
                                ...
                                const SizedBox(height: 6),
                                const Text('No pending payments right now.',
                                    style: AppText.body),
                              ]),
                            ),
                          ],
